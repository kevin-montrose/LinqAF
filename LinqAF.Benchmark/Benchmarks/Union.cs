...
namespace LinqAF.Benchmark.Benchmarks
{
    public class Union
    {
        ...
        public class OneParam
        {
            ...
            public void LinqAF()
            {
                foreach(var item in Source1.Union(Source2))
                {
                    GC.KeepAlive(item);
                }
            }
            ...
            {
                foreach (var item in System.Linq.Enumerable.Union(Source1, Source2))
                {
                    GC.KeepAlive(item);
                }
            }
        ...
        public class TwoParams
        {
            ...
            public void LinqAF()
            {
                foreach (var item in Source1.Union(Source2, Comparer))
                {
                    GC.KeepAlive(item);
                }
            }
            ...
            public void LINQ2Objects()
            {
                foreach (var item in System.Linq.Enumerable.Union(Source1, Source2, Comparer))
                {
                    GC.KeepAlive(item);
                }
            }
