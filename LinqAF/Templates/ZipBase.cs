...
namespace LinqAF
{
        ...
        where TEnumerator : struct, IStructEnumerator<TItem>
    {
        ...
        public ZipEnumerable<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator, IdentityEnumerable<TInnerItem, IEnumerable<TInnerItem>, IEnumerableBridger<TInnerItem>, IdentityEnumerator<TInnerItem>>, IdentityEnumerator<TInnerItem>> Zip<TInnerItem, TOutItem>(IEnumerable<TInnerItem> second, Func<TItem, TInnerItem, TOutItem> resultSelector)
        => CommonImplementation.Zip<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator>(RefThis(), second, resultSelector);

        public ZipEnumerable<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator, IdentityEnumerable<TInnerItem, Dictionary<TInnerItem, TDictionaryValue>.KeyCollection, DictionaryKeysBridger<TInnerItem, TDictionaryValue>, DictionaryKeysEnumerator<TInnerItem, TDictionaryValue>>, DictionaryKeysEnumerator<TInnerItem, TDictionaryValue>> Zip<TInnerItem, TOutItem, TDictionaryValue>(Dictionary<TInnerItem, TDictionaryValue>.KeyCollection second, Func<TItem, TInnerItem, TOutItem> resultSelector)
        ...
        public ZipEnumerable<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator, IdentityEnumerable<TInnerItem, HashSet<TInnerItem>, HashSetBridger<TInnerItem>, HashSetEnumerator<TInnerItem>>, HashSetEnumerator<TInnerItem>> Zip<TInnerItem, TOutItem>(HashSet<TInnerItem> second, Func<TItem, TInnerItem, TOutItem> resultSelector)
        => CommonImplementation.Zip<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator>(RefThis(), second, resultSelector);

        public ZipEnumerable<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator, IdentityEnumerable<TInnerItem, LinkedList<TInnerItem>, LinkedListBridger<TInnerItem>, LinkedListEnumerator<TInnerItem>>, LinkedListEnumerator<TInnerItem>> Zip<TInnerItem, TOutItem>(LinkedList<TInnerItem> second, Func<TItem, TInnerItem, TOutItem> resultSelector)
        => CommonImplementation.Zip<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator>(RefThis(), second, resultSelector);

        public ZipEnumerable<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator, IdentityEnumerable<TInnerItem, List<TInnerItem>, ListBridger<TInnerItem>, ListEnumerator<TInnerItem>>, ListEnumerator<TInnerItem>> Zip<TInnerItem, TOutItem>(List<TInnerItem> second, Func<TItem, TInnerItem, TOutItem> resultSelector)
        => CommonImplementation.Zip<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator>(RefThis(), second, resultSelector);

        public ZipEnumerable<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator, IdentityEnumerable<TInnerItem, Queue<TInnerItem>, QueueBridger<TInnerItem>, QueueEnumerator<TInnerItem>>, QueueEnumerator<TInnerItem>> Zip<TInnerItem, TOutItem>(Queue<TInnerItem> second, Func<TItem, TInnerItem, TOutItem> resultSelector)
        => CommonImplementation.Zip<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator>(RefThis(), second, resultSelector);

        public ZipEnumerable<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator, IdentityEnumerable<TInnerItem, SortedDictionary<TInnerItem, TDictionaryValue>.KeyCollection, SortedDictionaryKeysBridger<TInnerItem, TDictionaryValue>, SortedDictionaryKeysEnumerator<TInnerItem, TDictionaryValue>>, SortedDictionaryKeysEnumerator<TInnerItem, TDictionaryValue>> Zip<TInnerItem, TOutItem, TDictionaryValue>(SortedDictionary<TInnerItem, TDictionaryValue>.KeyCollection second, Func<TItem, TInnerItem, TOutItem> resultSelector)
        => CommonImplementation.Zip<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator, TDictionaryValue>(RefThis(), second, resultSelector);
        ...
        public ZipEnumerable<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator, IdentityEnumerable<TInnerItem, SortedSet<TInnerItem>, SortedSetBridger<TInnerItem>, SortedSetEnumerator<TInnerItem>>, SortedSetEnumerator<TInnerItem>> Zip<TInnerItem, TOutItem>(SortedSet<TInnerItem> second, Func<TItem, TInnerItem, TOutItem> resultSelector)
        => CommonImplementation.Zip<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator>(RefThis(), second, resultSelector);

        public ZipEnumerable<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator, IdentityEnumerable<TInnerItem, Stack<TInnerItem>, StackBridger<TInnerItem>, StackEnumerator<TInnerItem>>, StackEnumerator<TInnerItem>> Zip<TInnerItem, TOutItem>(Stack<TInnerItem> second, Func<TItem, TInnerItem, TOutItem> resultSelector)
        => CommonImplementation.Zip<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator>(RefThis(), second, resultSelector);

        public ZipEnumerable<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator, IdentityEnumerable<TInnerItem, TInnerItem[], ArrayBridger<TInnerItem>, ArrayEnumerator<TInnerItem>>, ArrayEnumerator<TInnerItem>> Zip<TInnerItem, TOutItem>(TInnerItem[] second, Func<TItem, TInnerItem, TOutItem> resultSelector)
        => CommonImplementation.Zip<TOutItem, TItem, TInnerItem, TEnumerable, TEnumerator>(RefThis(), second, resultSelector);

        public ZipEnumerable<TOutItem, TItem, TIdentityItem, TEnumerable, TEnumerator, IdentityEnumerable<TIdentityItem, TIdentityBridgeType, TIdentityBridger, TIdentityEnumerator>, TIdentityEnumerator> Zip<TOutItem, TIdentityItem, TIdentityBridgeType, TIdentityBridger, TIdentityEnumerator>(IdentityEnumerable<TIdentityItem, TIdentityBridgeType, TIdentityBridger, TIdentityEnumerator> second, Func<TItem, TIdentityItem, TOutItem> resultSelector)
        ...
        => CommonImplementation.Zip<TOutItem, TItem, TIdentityItem, TEnumerable, TEnumerator, IdentityEnumerable<TIdentityItem, TIdentityBridgeType, TIdentityBridger, TIdentityEnumerator>, TIdentityEnumerator>(RefThis(), ref second, resultSelector);
        ...
        public ZipEnumerable<TOutItem, TItem, GroupingEnumerable<TLookupKey, TLookupElement>, TEnumerable, TEnumerator, LookupDefaultEnumerable<TLookupKey, TLookupElement>, LookupDefaultEnumerator<TLookupKey, TLookupElement>> Zip<TOutItem, TLookupKey, TLookupElement>(LookupDefaultEnumerable<TLookupKey, TLookupElement> second, Func<TItem, GroupingEnumerable<TLookupKey, TLookupElement>, TOutItem> resultSelector)
        => CommonImplementation.Zip<TOutItem, TItem, GroupingEnumerable<TLookupKey, TLookupElement>, TEnumerable, TEnumerator, LookupDefaultEnumerable<TLookupKey, TLookupElement>, LookupDefaultEnumerator<TLookupKey, TLookupElement>>(RefThis(), ref second, resultSelector);

        public ZipEnumerable<TOutItem, TItem, GroupingEnumerable<TLookupKey, TLookupElement>, TEnumerable, TEnumerator, LookupSpecificEnumerable<TLookupKey, TLookupElement>, LookupSpecificEnumerator<TLookupKey, TLookupElement>> Zip<TOutItem, TLookupKey, TLookupElement>(LookupSpecificEnumerable<TLookupKey, TLookupElement> second, Func<TItem, GroupingEnumerable<TLookupKey, TLookupElement>, TOutItem> resultSelector)
        => CommonImplementation.Zip<TOutItem, TItem, GroupingEnumerable<TLookupKey, TLookupElement>, TEnumerable, TEnumerator, LookupSpecificEnumerable<TLookupKey, TLookupElement>, LookupSpecificEnumerator<TLookupKey, TLookupElement>>(RefThis(), ref second, resultSelector);
