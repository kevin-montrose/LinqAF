...
namespace LinqAF
{
    public partial struct EmptyOrderedEnumerable<TItem>
    {
        ...
        public EmptyOrderedEnumerable<TItem> ThenBy<TThenBy_SecondKey>(Func<TItem, TThenBy_SecondKey> keySelector)
        {
            if (IsDefaultValue()) throw CommonImplementation.Uninitialized("source");
        ...
        public EmptyOrderedEnumerable<TItem> ThenBy<TThenBy_SecondKey>(Func<TItem, TThenBy_SecondKey> keySelector, IComparer<TThenBy_SecondKey> comparer)
        {
            if (IsDefaultValue()) throw CommonImplementation.Uninitialized("source");
            if (keySelector == null) throw CommonImplementation.ArgumentNull(nameof(keySelector));
        ...
        public EmptyOrderedEnumerable<TItem> ThenByDescending<TThenBy_SecondKey>(Func<TItem, TThenBy_SecondKey> keySelector)
        {
            if (IsDefaultValue()) throw CommonImplementation.Uninitialized("source");
            if (keySelector == null) throw CommonImplementation.ArgumentNull(nameof(keySelector));
        ...
        public EmptyOrderedEnumerable<TItem> ThenByDescending<TThenBy_SecondKey>(Func<TItem, TThenBy_SecondKey> keySelector, IComparer<TThenBy_SecondKey> comparer)
        {
            if (IsDefaultValue()) throw CommonImplementation.Uninitialized("source");
            if (keySelector == null) throw CommonImplementation.ArgumentNull(nameof(keySelector));
        ...
        public EmptyOrderedEnumerable<TItem> CreateOrderedEnumerable<TThenBy_SecondKey>(Func<TItem, TThenBy_SecondKey> keySelector, IComparer<TThenBy_SecondKey> comparer, bool descending)
        {
            if (IsDefaultValue()) throw CommonImplementation.Uninitialized("source");
            if (keySelector == null) throw CommonImplementation.ArgumentNull(nameof(keySelector));
