...
namespace LinqAF.Tests
{
    ...
    public class ToListTests
    {
        ...
        public void Chaining_Weird()
        {
            ...
            Assert.IsTrue(lookup.ToList().SequenceEqual(new[] { groupByDefault.ElementAt(0), groupByDefault.ElementAt(1), groupByDefault.ElementAt(2) }, new _GroupingComparer<int>()));
