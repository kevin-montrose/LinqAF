...
namespace LinqAF.Tests
{
    ...
    public class SequenceEqualTests
    {
        static void _InstanceExtensionNoOverlapImpl(int spread, int take)
        {
            ...
            Helper.GetOverlappingMethods(typeof(Impl.ISequenceEqual<>), out instOverlaps, out extOverlaps, spread, take);
        ...
        public void Chaining_Weird()
        {
            ...
            // repeat
            {
                ...
                var repeatInt = Enumerable.Repeat(1, 1);
                Assert.IsFalse(repeatInt.SequenceEqual(range));
                Assert.IsFalse(repeatInt.SequenceEqual(range, new _IntComparer()));
